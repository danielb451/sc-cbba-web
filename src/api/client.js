...
export const api = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL || 'https://sc-cbb-web.up.railway.app/api',
  timeout: 20_000,
});
...
async function refreshAccessToken() {
  ...
  const baseURL = import.meta.env.VITE_API_BASE_URL || 'https://sc-cbb-web.up.railway.app/api';
